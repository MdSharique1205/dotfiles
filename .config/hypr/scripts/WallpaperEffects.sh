...
["Sepia Tone"]="magick $current_wallpaper -sepia-tone 95% $wallpaper_output"
["Sharpen"]="magick $current_wallpaper -sharpen 0x5 $wallpaper_output"
["Oil Paint"]="magick $current_wallpaper -paint 2 $wallpaper_output"
["No Effects"]="no-effects"
#["Vignette"]="magick $current_wallpaper -vignette 0x1 $wallpaper_output"
#["Posterize"]="magick $current_wallpaper -posterize 10 $wallpaper_output"
#["Polaroid"]="magick $current_wallpaper -polaroid 10 $wallpaper_output"
#["Negate"]="magick $current_wallpaper -negate $wallpaper_output"
#["Charcoal"]="magick $current_wallpaper -charcoal 0x2 $wallpaper_output"
#["Edge Detect"]="magick $current_wallpaper -edge 1 $wallpaper_output"
#["Emboss"]="magick $current_wallpaper -emboss 0x1 $wallpaper_output"
#["Solarize"]="magick $current_wallpaper -solarize 90% $wallpaper_output"
)
